...
fun PushSettings(session: String, me: User) {
    ...
    Box(Modifier.fillMaxWidth().lumoGlass(25)) {
        Column(Modifier.fillMaxWidth().padding(18.dp)) {
            Text("Уведомления — лаборатория", style = MaterialTheme.typography.titleMedium, color = androidx.compose.ui.graphics.Color.White)
